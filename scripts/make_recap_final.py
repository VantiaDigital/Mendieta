...
def main():
    ...
    # 9:16 (Reel, full) y 4:5 (carrusel). El movil del chat ya entra en la zona
    # de recorte, asi que el 4:5 es un crop centrado a pantalla completa (sin
    # barras): bandera, chat y comida llenan el cuadro.
